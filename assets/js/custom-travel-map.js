  ...
  loadTravelData(csvData = null) {
    if (csvData) {
      ...
      this.locations = [
        ...
        { name: 'New York', coords: [-74.0060152, 40.7127281], type: 'visited' },
        ...
        { name: 'Berlin', coords: [13.3888599, 52.5170365], type: 'visited' },
        ...
        { name: 'San Francisco', coords: [-122.419906, 37.7790262], type: 'home' },
        { name: 'Los Angeles', coords: [-118.242766, 34.0536909], type: 'visited' },
        { name: 'Reykjavik', coords: [-21.9422367, 64.145981], type: 'favorite' },
        ...
        { name: 'Ürgüp', coords: [34.95945521, 38.5928119], type: 'visited' },
        ...
        { name: 'New Delhi', coords: [77.2090057, 28.6138954], type: 'visited' },
        ...
        { name: 'Leh', coords: [77.5848133, 34.1642029], type: 'visited' },
        ...
        { name: 'Tokyo', coords: [139.7594549, 35.6828387], type: 'favorite' },
        ...
        { name: 'Pulau Bali', coords: [115.270385512, -8.4560181], type: 'visited' },
        { name: 'Sydney', coords: [151.2082848, -33.8698439], type: 'visited' },
        { name: 'Melbourne', coords: [144.9631608, -37.8142176], type: 'visited' },
        ...
        { name: 'San Juan', coords: [-66.116666, 18.465299], type: 'visited' },
        ...
        { name: 'Whistler', coords: [-122.9543022, 50.1171903], type: 'visited' },
        { name: 'New Haven', coords: [-72.9250518, 41.3082138], type: 'visited' },
        { name: 'Boston', coords: [-71.060511, 42.3554334], type: 'visited' },
        { name: 'Toronto', coords: [-79.3839347, 43.6534817], type: 'visited' },
        ...
        { name: 'South Lake Tahoe', coords: [-119.9843482, 38.9332411], type: 'visited' },
        { name: 'Sacramento', coords: [-121.493895, 38.5810606], type: 'visited' },
        { name: 'Santa Rosa', coords: [-122.7141049, 38.4404925], type: 'visited' },
        { name: 'Berkeley', coords: [-122.272863, 37.8708393], type: 'visited' },
        { name: 'Oakland', coords: [-122.271356, 37.8044557], type: 'visited' },
        { name: 'San Jose', coords: [-121.890591, 37.3361663], type: 'visited' },
        ...
        { name: 'Hershey', coords: [-76.6506001, 40.2854881], type: 'visited' },
        ...
        { name: 'Vik', coords: [-19.0054737, 63.4188166], type: 'visited' },
        ...
        { name: 'San José (CR)', coords: [-84.0795782, 9.9325427], type: 'visited' },
        { name: 'Ljubljana', coords: [14.5069289, 46.0500268], type: 'visited' },
        { name: 'Minneapolis', coords: [-93.2654692, 44.9772995], type: 'visited' },
        ...
        { name: 'Richmond', coords: [-77.43428, 37.5385087], type: 'visited' },
        { name: 'Concord', coords: [-71.537476, 43.207178], type: 'visited' },
        { name: 'Bangor', coords: [-68.7778138, 44.8011821], type: 'visited' }
      ];
    }
  }
  ...
  addMarkers() {
    this.locations.forEach(location => {
      ...
      markerElement.style.cssText = `
        width: 8px;
        height: 8px;
        background-color: ${location.type === 'home' ? '#4CAF50' : location.type === 'favorite' ? '#FF6B35' : '#DC2626'};
      ...
      const popup = new maplibregl.Popup({
        ...
        ">
          ${location.name}
          ${location.type === 'home' ? '<br><span style="font-size: 12px; color: #4CAF50;">🏠 Home</span>' : ''}
          ${location.type === 'favorite' ? '<br><span style="font-size: 12px; color: #FF6B35;">⭐ Favorite</span>' : ''}
        </div>
      `);
